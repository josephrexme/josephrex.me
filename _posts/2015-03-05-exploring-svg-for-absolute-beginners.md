...
The rectangle `rect` uses height and width attributes to define its shape like regular HTML elements. If you haven't know the used of `fill` all along, it's used to fill the vector graphic with a color.
