...
The golden ratio is represented with <span>&phi;</span> (phi) which can also be used as its mathematical constant **1.618** also known as the golden number. If you care about the math, [check wikipedia][1].
